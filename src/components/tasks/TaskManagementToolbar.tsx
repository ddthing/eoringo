...
type Props = { query:string; status:TaskStatusFilter; resetFilter:ResetFilter; onQueryChange:(value:string)=>void; onStatusChange:(value:TaskStatusFilter)=>void; onResetFilterChange:(value:ResetFilter)=>void };
...
export const TaskManagementToolbar = ({query,status,resetFilter,onQueryChange,onStatusChange,onResetFilterChange}:Props) => (

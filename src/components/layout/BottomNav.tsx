...
export const BottomNav = () => (
  <nav className="fixed inset-x-0 bottom-0 z-30">
    <div className="mx-auto max-w-3xl px-3 pb-[calc(0.65rem+env(safe-area-inset-bottom))]">
      <div className="grid grid-cols-5 rounded-[24px] border border-[rgb(var(--color-line-soft))] bg-card/92 p-1.5 shadow-soft">
        {navItems.map((item) => {
          ...
          return (
            <NavLink
              ...
              className={({ isActive }) =>
                [
                  "flex min-h-11 flex-col items-center justify-center gap-0.5 rounded-[18px] text-[11px] font-bold transition",

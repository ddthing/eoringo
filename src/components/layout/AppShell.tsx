...
export const AppShell = ({ children }: PropsWithChildren) => {
  ...
  return (
    <div className="min-h-screen bg-bg">
      <div className="mx-auto min-h-screen max-w-3xl border-x border-[rgb(var(--color-line-soft))] bg-[rgb(246_246_244/0.58)]">
        <header className="sticky top-0 z-20 border-b border-[rgb(var(--color-line-soft))] bg-[rgb(246_246_244/0.86)] backdrop-blur-xl">
